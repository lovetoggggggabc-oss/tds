...
assert.equal(playerProgress.starFragments, 3500, "all existing players receive the one-time 1,000 star-fragment grant");
assert.equal(playerProgress.starFragmentGrantVersion, 1, "the grant is versioned so it cannot repeat on reload");
