...
assert.match(html, /href="styles\.css\?v=48"/);
assert.match(html, /<script src="game\.js\?v=48" defer><\/script>/);
...
assert.match(html, /styles\.css\?v=48/, "the deployed stylesheet URL must change when its layout changes");
assert.match(html, /game\.js\?v=48/, "the deployed script URL must not reuse the pre-layout cache entry");
