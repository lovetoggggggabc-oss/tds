...
assert.match(html, /<script src="game\.js\?v=35" defer><\/script>/);
...
assert.match(js, /const BASE_MAX_HP = 150/);
...
assert.match(html, /styles\.css\?v=35/, "the deployed stylesheet URL must change when its layout changes");
assert.match(html, /game\.js\?v=35/, "the deployed script URL must not reuse the pre-layout cache entry");
