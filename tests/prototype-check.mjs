...
assert.match(html, /<script src="game\.js\?v=55" defer><\/script>/);
...
assert.match(html, /game\.js\?v=55/, "the deployed script URL must not reuse the pre-layout cache entry");
