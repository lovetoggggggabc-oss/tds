...
assert.equal((html.match(/<script src="game\.js\?v=27" defer><\/script>/g) || []).length, 1);

console.log("Runtime bootstrap smoke passed: DOM ready, 2 players, 30 slots, resources, wave 1, enemy spawn, and RAF verified.");
