...
const MAP_DEFINITIONS = Object.freeze({
  ORIGINAL_S: Object.freeze({
    ...
    route: buildSmoothRoute([
      {x:46.8,y:85.6},{x:47.0,y:82.0},{x:50.0,y:78.0},{x:52.0,y:74.0},
      {x:49.0,y:70.0},{x:45.0,y:68.0},{x:41.0,y:66.0},{x:38.0,y:64.0},
      {x:36.5,y:62.0},{x:36.5,y:60.0},{x:38.0,y:58.0},{x:41.0,y:56.0},
      {x:45.0,y:54.0},{x:50.0,y:52.0},{x:56.0,y:50.0},{x:61.0,y:48.0},
      {x:64.0,y:46.0},{x:66.0,y:44.0},{x:66.0,y:42.0},{x:65.0,y:40.0},
      {x:62.0,y:38.0},{x:58.0,y:36.0},{x:53.0,y:34.0},{x:49.0,y:32.0},
  ...
  LOOP_MAP: Object.freeze({
    ...
    spawn: Object.freeze({ x: 46.2, y: 86.5 }), destination: Object.freeze({ x: 73.2, y: 8.5 }),
    route: buildSmoothRoute([
      {x:46.2,y:86.5},{x:46.5,y:84},{x:46,y:82},{x:44.5,y:80},{x:42,y:78},{x:39,y:76},{x:36,y:74},{x:33,y:72},{x:30.5,y:70},{x:28.5,y:68},
      {x:27,y:66},{x:26.5,y:64},{x:26.5,y:62},{x:27,y:60},{x:28.5,y:58},{x:30.5,y:56},{x:33,y:54},{x:36,y:52},{x:39,y:50},{x:42,y:48},{x:45,y:46},{x:48,y:44},
      {x:52,y:42.5},{x:56,y:41.5},{x:60,y:41.3},{x:64,y:42},{x:68,y:43.5},{x:72,y:45.5},{x:75,y:48},{x:77,y:51},{x:78,y:54},{x:77.5,y:57},
      {x:76,y:59.5},{x:73.5,y:61.5},{x:70,y:63},{x:66,y:64},{x:62,y:64.5},{x:58,y:64},{x:54,y:63},{x:50.5,y:61.5},{x:47.5,y:59.5},{x:45.5,y:57},
      {x:44,y:54},{x:44,y:51},{x:45,y:48.5},{x:47,y:46},{x:50,y:44},{x:53,y:42},{x:56,y:40},{x:60,y:37.5},{x:64,y:35},{x:68,y:32},
      {x:71,y:29},{x:73,y:26},{x:74,y:23},{x:74,y:20},{x:74,y:16},{x:73.5,y:12},{x:73.2,y:8.5},
