...
const MAP_DEFINITIONS = Object.freeze({
  ...
  LOOP_MAP: Object.freeze({
    ...
    route: buildSmoothRoute([
      {x:40.7,y:85.2},{x:39.5,y:82},{x:38,y:80},{x:35.5,y:78},{x:33,y:76},{x:30.5,y:74},{x:28,y:72},{x:26,y:70},{x:25,y:68},{x:25,y:66},
      {x:26,y:64},{x:27.5,y:62},{x:29.5,y:60},{x:32.5,y:58},{x:35.5,y:56},{x:38.5,y:54},{x:41.5,y:51},{x:44,y:48},{x:47,y:46},{x:51,y:44.5},
      {x:56,y:43.5},{x:61,y:43.5},{x:65.5,y:44.5},{x:69,y:47},{x:71,y:50},{x:71,y:53},{x:68.5,y:56},{x:64,y:58.5},{x:58.5,y:59.5},{x:53,y:59},
      {x:49,y:57.5},{x:46.5,y:55},{x:46,y:52.5},{x:47,y:50},{x:49.5,y:47.5},{x:47,y:43},{x:50,y:40},{x:55,y:37.5},{x:60.5,y:34.5},{x:66,y:30},
